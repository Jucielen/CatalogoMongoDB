package br.com.compasso.productMongoDB.config;
...
public class SwaggerConfigurations {
	@Bean
	public Docket api() {
		Predicate<RequestHandler> basePackage = RequestHandlerSelectors.basePackage("br.com.compasso.productMongoDB");
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder()
				.title("Api de Catálogo de produtos com MongoDB")
